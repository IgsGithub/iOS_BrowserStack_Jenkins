...
//	public static By objiosSendAgainLinkInOTPVerificationPage=By.xpath("//*[@id='Send again' and @class='UIAStaticText']");
	...
	public static By objiosYearBoxInSignupScreen = By.xpath("(//*[@class='UIAPicker']//child::*)[3]|(//*[@type='XCUIElementTypePicker']/child::*)[3]"); // --------------------year
	// box
	//--------------------------------------------------fed--18----------------------------------------------
...
//	public static By objiosClearTextInPhoneNumberTextField=By.xpath("//*[@id='Clear text']");
	...
	public static By objiosPasswordTextFieldInSignUpScreen=By.xpath("//*[@placeholder='  Password']|//*[@value='  Password']");

	public static By objiosCompleteButtonInSignUpScreen=By.xpath("//*[@id='Complete' and @class='UIAButton']|//XCUIElementTypeButton[@name='Complete']");
	...
	//New login flow(Maltesh)
	public static By objiosEmailIDorMobileNumber=By.xpath("//*[@type='XCUIElementTypeTextField' and contains(@value,'mail')]");
	public static By objiosProceedButton=By.xpath("//*[@type='XCUIElementTypeButton' and @label ='Proceed']");
	
	public static By objiosLogInWithPassword=By.xpath("//*[@type='XCUIElementTypeStaticText' and @label ='Login with Password']");
	public static By objiosPasswordTextField=By.xpath("//*[@type='XCUIElementTypeSecureTextField' and contains(@value,'Pass')]");
	public static By objiosLogIn=By.xpath("//*[@type='XCUIElementTypeButton' and @name='Log in']");
//
...
//	public static By objiosWhensYourBirthday=By.xpath("(//*[contains(text(),'birthday')])[1]");
	...
	public static By objiosFullNameTextFieldInSignUpScreen=By.xpath("//*[contains(@placeholder,'  Full name')]|//*[contains(@value,'Full name')]");
...
//  +91 text in drop down in phone number text field		
	...
	//3dotsmenu
		...
		//Save password PopUp
		public static By objiosSavePasswordPopUp=By.xpath("//*[contains(@name,'Save Password')]");
	
		//Not now cta
		public static By objiosNotNowButtonInSavePasswordPopUp=By.xpath("//*[contains(@name,'Not Now')]");
		
		
		
		
		
		//PublishingInProcessInProfilePage
		public static By objiosPublishingInProcessInProfilePage=By.xpath("//XCUIElementTypeStaticText[@name='Publishing in process']");
		
		public static By objiosSubmitButtonInSetUserNamePage=By.xpath("//XCUIElementTypeButton[@name='Submit']");
		
		public static By objiosDoneButtonAfterSetUserNamePage=By.xpath("//XCUIElementTypeButton[@name='Done']");
