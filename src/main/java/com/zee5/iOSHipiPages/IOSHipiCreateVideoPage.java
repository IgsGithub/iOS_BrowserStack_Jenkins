...
//camera popup
public static By objiosCameraPopup=By.xpath("(//*[contains(@name,'Camera')])[1]");

//Allow acees of camera and microphone ok button
public static By objiosOkInAllowPopup=By.xpath("//*[@name='OK']");

//Don't Allow
public static By objiosDontAllowPopup=By.xpath("//*[@name='Don’t Allow']");

//microphone phone
public static By objiosMicrophone=By.xpath("(//*[contains(@name,'Microphone')])[1]");

//allow reqried permission
public static By objiosAllowPermission=By.xpath("//*[@name='You need to allow all required permissions']");

//ok permission
public static By objiosOkPermission=By.xpath("//*[@name='Ok']");
	
	
//Record Screen In Creator 

//record button In Record Screen
public static By iosRecordButon=By.xpath("//*[contains(@label,'record')]");

//record time below record button---changed-------------08-03-2022
public static By objiosCreationTimesInBelowRecordingBtn(String time) {
return By.xpath("//*[contains(@name,'com.zee5.hipi:id/Duration_"+time+"')]");
}



public static By objiosTimerInBelowRecordingBtnSelectedTrue(String time) {
return By.xpath("//*[contains(@name,'Duration_"+time+"_Btn_Selected_true')]");

}

//Next btn after record
public static By iosNextBtnAfterrecord=By.xpath("(//*[contains(@name,'Next')])[1]");


//Post btn after recording
public static By iosPostBtnAfterRec0rdng=By.xpath("(//*[@name='Post'])[1]");

public static By iosVideoLangSelect=By.xpath("//*[@type='XCUIElementTypeStaticText']//following-sibling::*[@value='Select']");

public static By iosVideoLangEnglish=By.xpath("//*[@value='English']");

public static By iosSelectVideoCategory = By.xpath("//XCUIElementTypeStaticText[@name='Select video category']");

public static By iosSelectCategoryDance = By.xpath("//XCUIElementTypeStaticText[@name='Dance']");

public static By iosSelectLanguageBackArrow=By.xpath("//*[@type='XCUIElementTypeButton' and contains(@name,'back_arrow')]");

//Video posted sucessfully toast msg
public static By objiosVideoPostedSucessfully=By.xpath("//*[contains(@id,'Uploading')]|(//*[@id='Progress'])[2] | (//XCUIElementTypeProgressIndicator[@name='Progress'])[2]");
public static By objiosUploadingStatus=By.xpath("//*[@type='XCUIElementTypeStaticText' and contains(@value,'Video posted')]");

//*[@type="XCUIElementTypeStaticText" and contains(@name,"Video posted")]

//SoundsInRecordScreen
public static By objiosSoundsInRecordScreen = By.xpath("(//*[contains(@name,'Sounds')])[1]");


//EffectCTAinRecordingScreen
public static By objiosEffectCTAinRecordingScreen = By.xpath("(//*[contains(@name,'Effects')])[1]");


public static By objiosFiltersNotDownloadedUnderAcategory(int index){
	int index1=index-1;
return By.xpath("//XCUIElementTypeCell[@name='com.zee5.hipi:id/assetCover"+index1+"']//child::*[@type='XCUIElementTypeButton' and @label='downloadd']");
}
//XCUIElementTypeCell[@name="com.zee5.hipi:id/assetCover0"]//child::*[@type='XCUIElementTypeButton' and @label='downloadd']
//XCUIElementTypeCell[@name="com.zee5.hipi:id/assetCover1"]//child::*[@type='XCUIElementTypeButton' and @label='downloadd']


//cross icon in Recording Screen
public static By objCrossIconInRecordingScreen=By.xpath("//*[contains(@name,'close')] | //*[contains(@name,'Nvback')]");
...
public static By objiosSpeedSeletedCTAInRecordScreen=By.xpath("//*[contains(@name,'Speed_Btn_Selected_true')]");

//speed selected false In Record Screen
public static By objiosSpeedNotSelectedCTAInRecordScreen=By.xpath("//*[contains(@name,'Speed_Btn_Selected_false')]");

//speed selected false In Record Screen
public static By objiosSpeedCTAInRecordScreen=By.xpath("//*[contains(@name,'Speed_Btn')]");

//BeautyModeSelected  true In Record Screen
public static By objiosBeautyModeSelected = By.xpath("//*[contains(@name,'Beauty_Btn_Selected_true')]");

//BeautyMode Selected false In Record Screen
public static By objiosBeautyModeCTA = By.xpath("//*[contains(@name,'Beauty_Btn_Selected_false')]");

//Filter Button Selected false In Record Screen
public static By objiosFilterButtonInVideoPage=By.xpath("//*[contains(@name,'Filter_')]");

//Timer In Record Screen
public static By objiosTimerInCreateVideo=By.xpath("//*[@name='cf_ic_timer']");

//Flash Light In Record Screen
public static By objFlashLightInCreatevideo=By.xpath("//*[contains(@name,'cf_ic_flash')]");

//Create video speed 0.3x
public static By objiosvideospeed0_3x = By.xpath("//*[contains(@name,'0.3x_')]");

//Create video speed  0.3x selected
public static By objiosvideospeed_0_3x_selected = By.xpath("//*[contains(@name,'Speed_0.3x_Btn_Selected_true')]");


//Create video speed 0.5x
public static By objiosvideospeed0_5x = By.xpath("//*[contains(@name,'0.5x_')]");

//Create video speed  0.5x selected
public static By objiosvideospeed_0_5x_selected = By.xpath("//*[contains(@name,'Speed_0.5x_Btn_Selected_true')]");

//Create video speed 1x
public static By objiosvideospeed_1x = By.xpath("//*[contains(@name,'1x_')]");

//Create video speed 1x selected
public static By objiosvideospeed_1x_selected = By.xpath("//*[contains(@name,'Speed_1x_Btn_Selected_true')]");

//Create video speed 1x not selected
public static By objiosvideospeed_1x_Notselected = By.xpath("//*[contains(@name,'Speed_1x_Btn_Selected_false')]");

//Create video speed 2x selected
public static By objiosvideospeed_2x_selected = By.xpath("//*[contains(@name,'Speed_2x_Btn_Selected_true')]");

//Create video speed 2x not selected
public static By objiosvideospeed_2x_Notselected = By.xpath("//*[contains(@name,'Speed_2x_Btn_Selected_false')]");

//Create video speed 1.5x
public static By objiosvideospeed1_5x = By.xpath("//*[contains(@name,'1.5x_')]");

//Create video speed  1.5x selected
public static By objiosvideospeed_1_5x_selected = By.xpath("//*[contains(@name,'Speed_1.5x_Btn_Selected_true')]");

//Create video speed 2x
public static By objiosvideospeed_2x = By.xpath("//*[contains(@name,'2x_')]");

//Upload in Recording Screen
public static By objUploadinRecordingScreen=By.xpath("//*[contains(@name,'gallery')]|//XCUIElementTypeImage[contains(@name,'gallery')]");

//Close Icon In Creator Page
public static By objCloseIconInCreatorPage=By.xpath("//*[contains(@name,'close')] |//*[contains(@name,'back')]");

//SoundTitleInRecordScreen
public static By objiosSoundTitleInRecordScreen = By.xpath("//*[@name='Nvback']//following-sibling::*[@knownSuperClass='UILabel']");

//SoundBtnAfterRecording
public static By objiosSoundBtnAfterRecording = By.xpath("//*[contains(@name,'NvSelectMusic')] | //*[contains(@name,'Sounds') and contains(@class,'utton')]");

//Flash Light Pop Up
public static By objFlashLightPopUpInCreateVideo=By.xpath("//*[contains(@name,'No Flash Detected')]");	

//closeBtnInRecoedScreen
public static By objioscloseBtnInRecoedScreen = By.xpath("//*[@name='com.zee5.hipi:id/closeButtonimg'] | //*[@name='Nvback']");
...
//Upload back button
public static By objiosbackbuttoninselectvideo=By.xpath("//*[contains(@id,'back')] | //XCUIElementTypeButton[contains(@name,'back_arrow')]|//XCUIElementTypeButton[contains(@name,'back')]");

//visible the song in create video page
public static By objiosSongVisibleInCreateVideo=By.xpath("(//*[@id='NvSelectMusic']//following-sibling::*)[3]");
...
public static By objiostickMarkInSoundSeletion = By.xpath("//*[contains(@id,'tick') and contains(@class,'Button')]");
...
public static By objDiscardEditsButtonInDiscardEditsPopUp=By.xpath("(//*[contains(@id,'DISCARD EDITS')])[1] | //XCUIElementTypeButton[@name='DISCARD EDITS']");
...
public static By objiosTrimTheSongs=By.xpath("//*[contains(@id,'Drag the select')]");

//Tick the trim
public static By objiosTickTheTrim=By.xpath("//*[@id='tick']");
...
public static By objiosCrossIconInSelectedMusic=By.xpath("(//*[contains(@id,'Nvback')])[2]");
...
public static By objSaveToDeviceEnableToggleButtonInPostPage=By.xpath("//*[contains(@id,'Save_toggle_Button_selected_True')]");
...
public static By objAllowSharingEnableToggleButtonInPostPage=By.xpath("//*[contains(@id,'Allow_Duet_toggle_Button_selected_True')]");
...
public static By objAllowLikesEnableInToggleButtonInPostPage=By.xpath("//*[contains(@id,'Allow_Likes_toggle_Button_selected_True')]");
...
public static By iosAddDescriptiontoyourvideo=By.xpath("//*[contains(text(),'commentBox')]");
...
public static By objAllowCommentEnableToggleButtonInPostPage=By.xpath("//*[contains(@id,'Allow_comments_toggle_Button_selected_True')]");
...
public static By objiosEnglishLanguageInPostScreen=By.xpath("//XCUIElementTypeStaticText[@name='English']");

public static By objiosOkButtonPopUpInGallary=By.xpath("//XCUIElementTypeButton[@name='OK']");

public static By objiosAddMeadiaButtonInGallary=By.xpath("//XCUIElementTypeStaticText[@name='Add Media']");

public static By objiosTickButtonInEditScreen=By.xpath("//XCUIElementTypeButton[@name='tick']");

public static By objiosVideoTimeInGallaryScreen=By.xpath("//XCUIElementTypeStaticText[@name='00:27']");

public static By objiosAllowAccesstoallPhotosInGallaryScreen=By.xpath("//XCUIElementTypeButton[@name='Allow Access to All Photos']");
