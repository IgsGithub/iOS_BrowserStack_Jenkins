...
public class IOSHiPiNeoDiscoverPage {
	...
	//(//XCUIElementTypeButton[@name="ic arrow top left"])[2]/parent::*/child::*[contains(@type,'XCUIElementTypeStaticText')]
	
	public static By objiosAutoSuggestionsInSearchParentPage(int k) {
		return By.xpath("(//XCUIElementTypeButton[@name='ic arrow top left'])["+k+"]/parent::*/child::*[contains(@type,'XCUIElementTypeStaticText')]");
	}
	
	
	
	//Search Field In Discover Page
		public static By objiosSearchFieldInDiscoverPage=By.xpath("//XCUIElementTypeNavigationBar[@name='HipiModule.DiscoverView']/XCUIElementTypeOther/XCUIElementTypeTextField");
		
		//Search field in search page
		public static By objiosSearchInSearchPage = By.xpath("//XCUIElementTypeTextField[contains(@value,'Search')]");
		
		
		//Search Button In Keyboard
			public static By objiosSearchButtonInKeyboard=By.xpath("//*[@class='UIAKeyboard']//child::*[contains(@id,'earch')]|//XCUIElementTypeButton[contains(@label,'search')]");

			
			
			public static By objiosProfileInDiscoverpage(int k) {
				return By.xpath("(//XCUIElementTypeStaticText[contains(@name,'profile_"+k+"')])[1]");
	...
	//(//XCUIElementTypeImage[contains(@name,'Video1')]//parent::*//child::*)[9]
	
	
			
	public static By objiosSearchResultVideosInTopSection(int k,int l) {
		return By.xpath("//XCUIElementTypeStaticText[contains(@name,'Video_"+k+"_total_likes')]//following-sibling::*["+l+"]");
	}
	//(//XCUIElementTypeImage[contains(@name,'Video"+k+"')]//parent::*//child::*)["+l+"]
	
	
	
	public static By objiosSearchResultVideosInTopSection=By.xpath("//XCUIElementTypeStaticText[contains(@name,'VIDEOS')]|//XCUIElementTypeImage[contains(@name,'Video')]");
	
	public static By objiosHashtagSectionUnderTopresults=By.xpath("//XCUIElementTypeStaticText[@name=\"HASHTAGS\"]");
	
	public static By objiOSHashTagitemUnderTopSection(int k) {
		return By.xpath("//XCUIElementTypeStaticText[contains(@name,'Hashtag_"+k+"')]");
	}
	
public static By objiosSoundsSectionUnderTopresults=By.xpath("//XCUIElementTypeStaticText[@name='SOUNDS']");
	
	public static By objiOSSounditemUnderTopSection(int k) {
		return By.xpath("//XCUIElementTypeStaticText[contains(@name,'Sound_"+k+"')]");
	}
	
	//*[@type='XCUIElementTypeCollectionView']//child::*//XCUIElementTypeOther[@name="Users"]
	
	//Tabnames are Top, Users,  Videos,  Sounds,  HashTags
			public static By objiosTabnameInDiscoverSearchResultsPage(String tabname) {
				return By.xpath("//*[@type='XCUIElementTypeCollectionView']//child::*//XCUIElementTypeOther[@name='"+tabname+"']");
			}
	
	
	public static By objiOSSearchResultsUnderUsersSection(int k) {
		return By.xpath("//XCUIElementTypeStaticText[@name='com.zee5.hipi:id/profile_"+k+"']");
	}
	
	
	public static By objiosFirstSoundTitleInSoundsTab=By.xpath("(//XCUIElementTypeStaticText[@name='com.zee5.hipi:id/Sound_1'])[1]");
	
	
	public static By objiOSSounditemUnderSoundSection(int k) {
		return By.xpath("(//XCUIElementTypeStaticText[@name='com.zee5.hipi:id/Sound_1'])["+k+"]");
	}
	...
	//HashTag in Discover Search Tab
		...
		public static By HastagInDiscoverSearchTab(int index){
			return By.xpath("//*[@name='com.zee5.hipi:id/Hashtag_"+index+"']");
			//*[@name='com.zee5.hipi:id/Hashtag_1']
		}
	
	
		//Back Button In Discover Page
				public static By objBackButtonInDiscoverPage=By.xpath("//*[contains(@label,'back')] | //XCUIElementTypeButton[contains(@name,'back_arrow')]");
	
	
	

public static By objiosFirstVideoInVideosScreen(int k) {
	return By.xpath("(//*[contains(@name,'Video1')])["+k+"]");
}


	
		 public static By objiosPlayIconInVideosTab(int k) {
			 return By.xpath("(//*[contains(@name,'outline_Play')])["+k+"] | //*[contains(@id,'total_views_1')]");
		 }
		 
		 
		 public static By objiosAutoSuggestionsInSearchParentPage=By.xpath("(//XCUIElementTypeTable//XCUIElementTypeCell//*[contains(@type,'Text')])[1]");
			 
		 
			public static By objiosBannerImageInDiscoverpage=By.xpath("//*[contains(@name,'Banner_')]");
			
		 
		 
		 
			 
	  		 public static By objiosBannerInDiscoverpage=By.xpath("//XCUIElementTypePageIndicator[contains(@name,'Page')]");
	  		//XCUIElementTypePageIndicator[@name="com.zee5.hipi:id/Page_Indicator"]
	  		 

	 		public static By objiosRailsnameInDiscoverSearchResultsPage(String Railname) {
	 		return By.xpath("//*[contains(@name,'RailName') and (@value='"+Railname+"')]");
	 		}
	 		
	 			 

			public static By objiosRightFacingArrowForTray(String trayTitle){
				return By.xpath("//*[contains(@value,'"+trayTitle +"')]//parent::*//*[contains(@name,'arrow')]");
				//*[contains(@value,'Top Hipi Stars')]//parent::*//*[contains(@name,'arrow')]
			}
			
	
			

			public static By objiosFollowInRails=By.xpath("(//*[@name='Follow'])[1]");
			
			

			public static By objiosHastagTrayArrowButton=By.xpath("((//*[contains(@name,'HashTag_RailName')])[1]//parent::*//following-sibling::*)[2]");
	

			public static By objiosHashtagTitle=By.xpath("//*[@name='com.zee5.hipi:id/Hashtag_title'] | //XCUIElementTypeStaticText[contains(@name,'UsernameNavigationBarProfilePage')]");
    ...
    public static By objiosPlayIconInVideosTab=By.xpath("(//*[contains(@name,'outline_Play')])[1] | //*[contains(@id,'total_views_1')]");
...
//		public static By objBackButtonInDiscoverPage=By.xpath("//*[contains(@id,'back')]");
	...
	public static By objiosTrendingHipiRail=By.xpath("//*[contains(text(),'#Trendingon')]");
