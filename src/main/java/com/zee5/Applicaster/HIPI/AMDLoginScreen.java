...
//	public static By objEmailIdField = By.xpath("//*[@id='edit_email']");
	public static By objEmailIdField = By.xpath("//*[@resource-id='com.zee5.hipi:id/et_email']");
...
//	public static By objProceedBtn = By.xpath("//*[@id='btnProceed']");
	public static By objProceedBtn = By.xpath("//*[@class='android.widget.Button' and @text='Proceed']");
	
	// Password field
	public static By objPasswordField = By.xpath("//*[@id='etPassword']");
	...
	// Login button
	public static By objLoginBtn = By.xpath("//*[@id='btnSendCode']");

	public static By objLoginButton = By.xpath("//*[contains(@resource-id,'btnLogin')]");
	...
	public static By objLoginScreenTitle = By
			.xpath("//*[@resource-id='com.zee5.hipi:id/screen_title' and @text='Login']");
	public static By objLoginOrRegisterPageTitle = By
			.xpath("//*[@resource-id='com.zee5.hipi:id/screen_title' and @text='Login/Register']");

	// Forgot password screen title
	public static By objForgotPasswordScreenTitle = By
			.xpath("//*[@resource-id='com.zee5.hipi:id/screen_title' and @text='Forgot Password']");
	// Login with OTP link
	public static By objLoginWithOTPLink = By.xpath("//*[contains(@resource-id,'tvLoginWithOTP')]");

	public static By objOtpScreenTitle = By
			.xpath("//*[@resource-id='com.zee5.hipi:id/screen_title' and @text='Verify Mobile']");
	public static By objOtpEditBox1 = By.xpath("//*[contains(@resource-id,'otpEditText1')]");
	public static By objOtpEditBox2 = By.xpath("//*[contains(@resource-id,'otpEditText2')]");
	public static By objOtpEditBox3 = By.xpath("//*[contains(@resource-id,'otpEditText3')]");
	public static By objOtpEditBox4 = By.xpath("//*[contains(@resource-id,'otpEditText4')]");
	public static By objResendOtpLink = By.xpath("//*[contains(@resource-id,'didntGetTheOTPId')]");
	public static By objVerifyBtn = By.xpath("//*[contains(@resource-id,'verifyButton')]");
	public static By objOtp = By.xpath("//*[contains(@resource-id,'otpSentAndChangeNumberTextViewId')]");
	public static By objCountDownTimer = By.xpath("//*[contains(@resource-id,'countDownTimerTextViewId')]");
	public static By objRegistrationScreenTitle = By
			.xpath("//*[@resource-id='com.zee5.hipi:id/screen_title' and @text='Register for FREE']");
	public static By objDisplayLanguageScreenTitle = By.xpath("//*[@id='screen_title' and @text='Display Language']");
	public static By objPageTitle = By.xpath("//*[contains(@resource-id,'dl_screen_title')]");
	public static By objContentLanguageScreenTitle = By
			.xpath("//*[@resource-id='com.zee5.hipi:id/screen_title' and @text='Content Language']");
	...
	public static By objTickmarkforSelectedDisplayLanguage = By.xpath("//*[contains(@resource-id,'selectionImage')]");
	...
	//public static By objGoogleBtn = By.xpath("//*[@id='btnGoogle']");
	//google account
			public static By objgoogleaccount=By.xpath("//*[@resource-id='com.google.android.gms:id/account_name']");
	//password field
			public static By objpassworldField=By.xpath("//*[@resource-id='com.twitter.android:id/login_password']");

	//allowauthorize
			public static By objTwitterAuthorizeAllow=By.xpath("//*[@text='AUTHORISE APP']");

			public static By objTwitterloginButton=By.xpath("//*[@resource-id='com.twitter.android:id/login_login']");
