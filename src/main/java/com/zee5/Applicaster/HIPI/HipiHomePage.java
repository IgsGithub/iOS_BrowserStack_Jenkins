...
public class HipiHomePage {
	...
	public static By objShareIcon = By.xpath("//*[contains(@resource-id,'share')]");
	...
	//-------------------------------------------Kartheek------------------------------------------------
		...
		//Shop Button
		public static By objShopButton = By.xpath("//*[@resource-id='com.zee5.hipi:id/shoppable_text']");
		// product image 1
		...
		//User Name
		public static By objUserName=By.xpath("//*[@resource-id='com.zee5.hipi:id/text_view_account_handle']");
		//List of Hashtag
		...
		//-------------------------------------------------
			...
			public static By objShareoptions(int index) {
				...
				public static By objDuet = By.xpath("//*[@id='duetVideo']");
