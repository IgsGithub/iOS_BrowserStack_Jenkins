...
//	public static By objPrivacyPolicyHeader = By.xpath("//*[@text='Privacy Policy']");
	...
	//Share options Effect Page
	public static By objShareOptionsEffectPage = By.xpath("//*[@resource-id='android:id/text1'] | //*[@resource-id='vivo:id/text1'] | //*[@resource-id='com.zee5.hipi:id/title']");
	
	public static By objShareoptions(int index) {
		return By.xpath("(//*[@resource-id='android:id/text1'] | //*[@resource-id='vivo:id/text1'] | //*[@resource-id='com.zee5.hipi:id/title'])[" + index + "]");
