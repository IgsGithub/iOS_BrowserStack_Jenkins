...
//	Login Popup
	...
	//usePhone or Email
		...
		//Gender Drop Down
		public static By objGenderDropDown = By.xpath("//*[@resource-id='com.zee5.hipi:id/ivDropDown']");
		//Gender Text Field
		public static By objGenderTextField = By.xpath("//*[@id='etGender']");
...
//		Login In Title
		public static By objLoginTitle = By.xpath("//*[@resource-id='com.zee5.hipi:id/title']");
...
//		Sign up for HiPi Title
		public static By objSignUpHiPiTitle= By.xpath("//*[@resource-id='com.zee5.hipi:id/title' and @text='Sign up at Hipi']");
