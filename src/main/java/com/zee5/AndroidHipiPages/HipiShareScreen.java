...
public class HipiShareScreen {
	...
	//Hipi Logo
	public static By objHipiLogo= By.xpath("//*[@text='Hipi']");
	...
	// To Field
	public static By objToField = By.xpath("//*[@resource-id='com.google.android.gm:id/peoplekit_autocomplete_chip_group']//child::*");
...
//  ']					
	...
	//Message Text Box
	public static By objMessageTextBox= By.xpath("//*[@resource-id='com.android.mms:id/embedded_text_editor']");
	
	public static By objSharescreenMoreRail= By.xpath("//*[@class='com.android.internal.widget.RecyclerView']");

	public static By objListOfShareRail= By.xpath("//*[@id='oplus_resolver_pager'] | //*[@resource-id='android:id/text1']");
