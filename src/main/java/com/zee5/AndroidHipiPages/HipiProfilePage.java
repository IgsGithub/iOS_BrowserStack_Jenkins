...
//----------------------------------------Kartheek Reddy-----------------------------------------------------
	...
	//Share Button
	public static By objShareButton= By.xpath("//*[@resource-id='com.zee5.hipi:id/imgShare']");
	//Back Button
	...
	//  Posted video music title
		...
		public static By objPostedvideoFilterTitle= By.xpath("//*[@id='text_view_filter_title']");	
			...
			public static By objFirstVideo= By.xpath("(//*[@resource-id='com.zee5.hipi:id/videoImg'])[1]");
		    //verify Hashtag
	...
	//---------------------------------Deepa----------------------------------------------------
		...
		// shear icon		
				public static By objShearIcon= By.xpath("//*[@resource-id='com.zee5.hipi:id/imgShare']");	
...
public static By objVideoTabFirstVideo = By.xpath("(//*[@id='VideoResultRecyclerView']/*/*[@id='imgLayout' and (./preceding-sibling::* | ./following-sibling::*)[@id='title']])[1]");
...
public static By objMessageBox=By.xpath("//*[@resource-id='com.zee5.hipi:id/messageBox']");

public static By objSendMessageButton=By.xpath("//*[@resource-id='com.zee5.hipi:id/sendMessage']");
...
public static By objMessage=By.xpath("//*[@resource-id='com.zee5.hipi:id/myMessageTextView']");
...
public static By objDraftVideoThumbnail=By.xpath("//*[@resource-id='com.zee5.hipi:id/videoTumbNailImg']");
