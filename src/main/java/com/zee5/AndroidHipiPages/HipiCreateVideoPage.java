...
public class HipiCreateVideoPage {
	...
	// record btn
	public static By objrecordbtn = By.xpath("//*[@id='record_btn']");
	...
	// filter
	public static By objfilter = By.xpath("//*[contains(@resource-id,'filter_toggle')]");
	...
	public static By objCreatePermissionVideo = By.xpath("//*[@id='permission_message']");
	public static By objCreateAllow = By.xpath("//*[@id='permission_allow_foreground_only_button' or @id='permission_allow_button']");
	...
	public static By objCreateVideoFlip = By.xpath("//*[contains(@resource-id,'flipButton')]");
	public static By objCreateVideoFlipEnabled = By
			.xpath("//*[contains(@resource-id,'flipButton') and @checked='true']");

	public static By objCreateVideoFlash = By.xpath("//*[contains(@resource-id,'flashButton')]");
	public static By objCreateVideoFlashEnabled = By
			.xpath("//*[contains(@resource-id,'flashButton') and @checked='true']");

	public static By objCreateVideoSpeedButton = By.xpath("//*[contains(@resource-id,'speed_toggle')]");
	...
	public static By objtimerbtn = By.xpath("//*[contains(@resource-id,'timer_toggle')]");
	...
	public static By objbeautybtn = By.xpath("//*[contains(@resource-id,'beauty_toggle')]");
	...
	public static By objbeautytoggle = By.xpath("//*[contains(@resource-id,'beauty_toggle')]");
	...
	public static By objdefaultRecordTime = By.xpath("//*[@id='recordTotalTime']");
...
//==============================================Muthu kumaran M===========================================
		...
		//Speed Button
		public static By objSpeedButton=By.xpath("//*[@resource-id='com.zee5.hipi:id/speed_toggle']");
		...
		//Flash Button
		public static By objFlashButton=By.xpath("//*[@resource-id='com.zee5.hipi:id/flashButton']");
		//Flash Disable Popup
		...
		//Camera Flip new
		public static By objCameraFlipnew = By.xpath("//*[@id='flipButton']");
		...
		//Select Sound Search
		public static By objSelectFirstSound=By.xpath("(//*[@resource-id='com.zee5.hipi:id/music_name'])[1]");
		//Sound Header Text
		public static By objSoundHeaderText=By.xpath("//*[@resource-id='com.zee5.hipi:id/toolbar_text']");
		//Select Music Button
		public static By objSelectMusicButton=By.xpath("//*[@resource-id='com.zee5.hipi:id/select_music_use_btn']");
		...
		public static By objFirstSearchResults=By.xpath("(//*[@id='rv_auto_suggestion']/*/*/*[@class='android.widget.TextView' and ./parent::*[@class='android.widget.LinearLayout' and ./parent::*[@id='rl_car']]])[1]");
...
//		public static By objVisibilityFrindsButton= By.xpath("");
	...
	//-------------------------------------------------------
	  ...
	  //-------------------------------suhail--------------------------
		//video edit screen first effect
				public static By objEffectsFirstEffect=By.xpath("(//*[@resource-id='com.zee5.hipi:id/transparent'])[1]");
		...
		public static By objSoundScreenIndemendRail=By.xpath("//*[@class='android.widget.LinearLayout' and ./*[@contentDescription='ID4circular'] and ./*[@id='layoutHeader']]");
	...
	//First suggested Text
		public static By objSoundFirstSuggestedText = By.xpath("(//*[@id='rv_auto_suggestion']/*/*/*[@text and @class='android.widget.TextView' and ./parent::*[@class='android.widget.LinearLayout' and ./parent::*[@id='rl_car']]])[1]");
	...
	//first Existing record item
		public static By objSoundsExistingRecord = By.xpath("(//*[@id='addMusicResultAllRecyclerView']/*/*/*/*[@id='music_name'])[1]");
	//music screen header
		public static By objMusicScreenHeader = By.xpath("//*[@resource-id='com.zee5.hipi:id/select_music_name']");
		//Selected Music
		public static By objSelectedMusic = By.xpath("//*[@resource-id='com.zee5.hipi:id/musicName']");

	//Music Screen pause Icon
		public static By objMusicScreenPauseBtn = By.xpath("//*[@id='select_music_pause_btn']");
	//Music Screen Tick Icon
		public static By objMusicScreenTickIcon = By.xpath("//*[@resource-id='com.zee5.hipi:id/select_music_use_btn']");
	// Video Screen Header
	...
	// audio screen music time
		...
		public static By objDiscardPopupDiscaedEdits = By.xpath("//*[@id='ok_btn']");
	...
	//upload video from gallery Edit This Video Button	
		public static By objGalleryEditThisVideoButton= By.xpath("//*[@id='sigle_tv_startEdit']");
	...
	//uploaded video Thumbnail
		...
		public static By objGallerySelectVideoPopup= By.xpath("//*[@id='text_center']");
		...
		public static By objSoundsAnySound2 = By.xpath("(//*[@resource-id='com.zee5.hipi:id/musicName'])[2]");
...
//		downloadin video percentage popup
	...
	//Post screen First suggested user/friend;
		public static By objPostScreenFirstFriendSuggestedUser= By.xpath("(//*[@id='user_name'])[1]");
	...
	//postscreen save to device 
		...
		public static By objDiscardPopupkeepButton=By.xpath("//*[@id='cancel_btn']");
//		Trim screen heaader
		...
		public static By objFIlterScreenClearIcon=By.xpath("//*[@id='img_clear']");
				...
				public static By objVideoEditScreenEditclip = By.xpath("//*[@id='stickerImageView']");
				...
				public static By objEditclipscreenRightPlusIcon = By.xpath("//*[@id='addImage_right']");
						...
						public static By objEditClipAddMedia = By.xpath("//*[@id='media_tv_startEdit']");
						...
						public static By objEditclipTrim = By.xpath("(//*[@id='effectRecyclerView']/*/*[@id='imageAsset'])[1]");
						public static By objEditClipTrimscreenTick = By.xpath("//*[@id='trimFinish']");
						public static By objEditClipDurationInfo = By.xpath("//*[@id='trimDurationVal']");
						...
						public static By objTrimscreenCrossIcon= By.xpath("//*[@id='select_music_close_btn']");
						...
						public static By objLocalTab=By.xpath("//*[contains(text(),'Local')]");
						...
						{
						return By.xpath("(//*[@id='music_name'])["+num+"]");
						}
						...
						public static By objLocalSoundsTrimTick=By.xpath("//*[@id='select_music_use_btn']");
						
						public static By objSoundSearchListPlayIcon=By.xpath("(//*[@id='addMusicResultAllRecyclerView']/*/*/*/*/*[@id='music_play_btn'])[1]");
						public static By objSoundSearchListThumbnail=By.xpath("(//*[@resource-id='com.zee5.hipi:id/image_view'])[1]");
