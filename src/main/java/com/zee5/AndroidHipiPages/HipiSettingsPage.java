...
//----------------------------------------------------------------------------------------------------------------------
	...
	//Account
		public static By objAccount = By.xpath("//*[@resource-id='com.zee5.hipi:id/tvAccount']");
	//Change password
		public static By objChangePassword = By.xpath("//*[@resource-id='com.zee5.hipi:id/tvManageAcnt']");
	//Privacy
		public static By objPrivacy = By.xpath("//*[@resource-id='com.zee5.hipi:id/tvPrivacy']");
	//Share Profile
		public static By objShareProfile = By.xpath("//*[@resource-id='com.zee5.hipi:id/tvSharePrfl']");
	...
	//Help Center
		public static By objHelpCenter = By.xpath("//*[@resource-id='com.zee5.hipi:id/tvHelp']");
	//Content Complaints
		public static By objContentComplaints = By.xpath("//*[@resource-id='com.zee5.hipi:id/tvComplaint']");
	//About
		public static By objAbout = By.xpath("//*[@resource-id='com.zee5.hipi:id/tvAbout']");
	//Community Guidelines
		public static By objCommunityGuidelines = By.xpath("//*[@resource-id='com.zee5.hipi:id/tvCommnty']");
	//Terms of Use
		public static By objTermsOfUse = By.xpath("//*[@resource-id='com.zee5.hipi:id/tvTerms']");
	//Community Centre
		public static By objCommunityCentre = By.xpath("//*[@resource-id='com.zee5.hipi:id/tvPrivacyPolicy']");
	//Log out
		public static By objLogOut = By.xpath("//*[@resource-id='com.zee5.hipi:id/tvLogout']");
	//Version
	...
	//Search Field in help center	
		...
		//Search result
				...
				public static By objToggleButtonOff=By.xpath("//*[@text='Private account OFF' and @id='tvPrivateAcnt']");
				...
				//Invite Friends
				public static By objInviteFriends=By.xpath("//*[@resource-id='com.zee5.hipi:id/tvReferEarn']");
			...
			//Like privacy Noone button
				...
				//Need help first link
					public static By objQuickLinksFirstLink=By.xpath("//*[@id='tvCommnty'and@clickable='true']");
			...
			//Landing Screen of Hipi help center links
					public static By objLandingScreenHiperlinkOfHelpCentre=By.xpath(" //*[@id='tvReferEarn']");
