...
public class GmailInbox {
	...
	public String read(String subject) {
		...
		//"jenkinshipi@gmail.com", "bapnwdzfkojhjbbr"
		
		try {
			Session session = Session.getInstance(props, new javax.mail.Authenticator() {
				protected PasswordAuthentication getPasswordAuthentication() {
					return new PasswordAuthentication("jenkinshipi@gmail.com", "bapnwdzfkojhjbbr");
				}
			});
			Store store = session.getStore("imaps");
			store.connect("smtp.gmail.com", "jenkinshipi@gmail.com", "bapnwdzfkojhjbbr");
