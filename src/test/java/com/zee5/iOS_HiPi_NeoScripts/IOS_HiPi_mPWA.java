...
//	@Test(priority =2)
	...
	public void TimeTakenToAppNavigationToAppStoreClickingOnCreateButton(String userType,String InstallBuild) throws Exception{
		...
		//@Test(priority =6)
		@Parameters({ "userType", "InstallBuild" })
		public void LogInFromPhoneNumber(String userType,String InstallBuild) throws Exception{
			Zee5mWebHipiNeoBusinessLogic.MPWALoginWithPhoneNumber(userType,"MPWA_TC008");
		}
	...
	public void FeedScreenArrivalTime(String userType, String InstallBuild) throws Exception{
		...
		Zee5mWebHipiNeoBusinessLogic.searchResults("punjabi", "MPWA_TC0013");
		Zee5mWebHipiNeoBusinessLogic.searchResults("love", "MPWA_TC0014"); 
		Zee5mWebHipiNeoBusinessLogic.searchResults("shivangi", "MPWA_TC008");
		Zee5mWebHipiNeoBusinessLogic.searchResults("shraddha aryaa", "MPWA_TC009");
